...
KC_ASDF_NAME="asdf-chezmoi"
KC_ASDF_REPO="https://github.com/kc-workspace/asdf-chezmoi"
export KC_ASDF_ORG KC_ASDF_NAME KC_ASDF_REPO

## Application information
KC_ASDF_APP_TYPE="standalone"
KC_ASDF_APP_NAME="chezmoi"
KC_ASDF_APP_WEBS="https://www.chezmoi.io"
KC_ASDF_APP_DESC="Manage your dotfiles across multiple diverse machines, securely."
KC_ASDF_APP_CMDS="
- test    - test if cli exist and executable
- version - print *plugin* version
"
KC_ASDF_APP_REPO="https://github.com/twpayne/chezmoi"
